...
![](C:\Users\86159\AppData\Roaming\Typora\typora-user-images\image-20200820091821236.png)
...
![](C:\Users\86159\AppData\Roaming\Typora\typora-user-images\image-20200820091904896.png)
...
* 为类变量分配内存并且设置该类变量的==默认初始值==。

* ==用final修饰==的static的变量，==准备阶段会显式初始化==，因为final在编译的时候就会分配了；
...
- 也就是说，当我们代码中包含==类变量或者static静态代码块==的时候，就会有clinit方法
